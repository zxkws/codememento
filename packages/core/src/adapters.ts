...
import type { AdapterName, AgentDocsConfig, RepositoryDetection } from './types.js';
import { agentsContent } from './templates.js';

export interface Adapter {
  name: AdapterName;
  path: string;
  content(config: AgentDocsConfig, detection: RepositoryDetection): string;
}
